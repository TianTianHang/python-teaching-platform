...
Define lazy rendering behavior for markdown content to improve initial page load performance. Heavy components (code blocks, foldable blocks) are deferred until they enter the viewport.
