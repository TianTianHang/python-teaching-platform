# Spec: Chapter Prerequisites (Unlock Conditions)
...
- [progress-cache](../../../specs/progress-cache/spec.md) - Chapter completion tracking that feeds into unlock status
- [course-import](../../../specs/course-import/spec.md) - Course import/export should support unlock conditions
- [nested-route-cache](../../../specs/nested-route-cache/spec.md) - Cache invalidation patterns for unlock status
