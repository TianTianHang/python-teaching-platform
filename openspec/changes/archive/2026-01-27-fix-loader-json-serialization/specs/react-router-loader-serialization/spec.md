...
This specification defines requirements for ensuring React Router v7 loaders and actions return JSON-serializable data, preventing runtime "Value is not JSON serializable" errors during SSR and client-side hydration.
...
- **Related Specs**: None (this is a new specification)
- **Related Changes**:
  - `fix-loader-json-serialization`: Implements these requirements
